...
class MyProfileViewController: AvatarViewController {
    ...
    func updateUI(){
        ...
        if(self.getDayString(day:Date()) == myClientVo?.lastAttendance)
        {
            ...
            attendanceBtn.setTitle(Language.getString("已签到"), for: .normal)
        }
