...
class PostDetailController: UIViewController, UITableViewDelegate, UITableViewDataSource,UIWebViewDelegate,UITextFieldDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if sysMsg {
            self.navigationItem.title = Language.getString("系统消息")//titleString//String(htmlEncodedString: titleString);
        }else{
            self.navigationItem.title = Language.getString("探索")//titleString//String(htmlEncodedString: titleString);
        }
    }
