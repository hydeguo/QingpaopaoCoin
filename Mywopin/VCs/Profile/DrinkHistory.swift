...
class DrinkHistory: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lineChart.cx.labels.values = [Language.getString("星期一"), Language.getString("星期二"), Language.getString("星期三"), Language.getString("星期四"), Language.getString("星期五"), Language.getString("星期六"), Language.getString("星期日")]
